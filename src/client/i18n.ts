...
export const ZH_DICT = {
  ...
  'settings.pref.confirmWritesHint': '总开关：开启后按下方类目决定是否弹确认卡，关闭后除删除（始终确认）外一律直接执行。',
...
const EN_DICT: Record<XyKey, string> = {
  ...
  'settings.pref.confirmWritesHint': 'Master switch: when on, confirmations follow the categories below; when off, everything except deletes (always confirmed) runs directly.',
