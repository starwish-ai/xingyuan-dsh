...
export const ZH_DICT = {
  ...
  'confirm.futureAt': '「{name}」{date}不是打卡日，提前打卡表示承诺当天完成。确认？',
  ...
  'growth.lv.2.reward': '解锁更多 AI 对话功能',
  'growth.lv.3.name': '实践者',
  'growth.lv.3.reward': '获得专属头像框',
  'growth.lv.4.name': '坚持者',
  'growth.lv.4.reward': '解锁高级教练风格',
  'growth.lv.5.name': '奋斗者',
  'growth.lv.5.reward': '获得专属徽章',
  'growth.lv.6.name': '进取者',
  'growth.lv.6.reward': '解锁更多任务模板',
  'growth.lv.7.name': '成就者',
  'growth.lv.7.reward': '获得专属称号',
  'growth.lv.8.name': '卓越者',
  'growth.lv.8.reward': '解锁全部教练风格',
  'growth.lv.9.name': '领航者',
  'growth.lv.9.reward': '获得限定头像框',
  'growth.lv.10.name': '星愿大师',
  'growth.lv.10.reward': '解锁全部特权，成为星愿大师',
  ...
  'err.no_opportunity_left': '没有可勾选的打卡日：机会日已全部完成或截止',
...
const EN_DICT: Record<XyKey, string> = {
  ...
  'cal.cellTitle.none': '{date}, nothing scheduled',
  ...
  'growth.lv.2.reward': 'Unlock more AI chat features',
  'growth.lv.3.name': 'Practitioner',
  'growth.lv.3.reward': 'Earn an exclusive avatar frame',
  'growth.lv.4.name': 'Perseverer',
  'growth.lv.4.reward': 'Unlock advanced coach styles',
  'growth.lv.5.name': 'Striver',
  'growth.lv.5.reward': 'Earn an exclusive badge',
  'growth.lv.6.name': 'Go-getter',
  'growth.lv.6.reward': 'Unlock more task templates',
  'growth.lv.7.name': 'Achiever',
  'growth.lv.7.reward': 'Earn an exclusive title',
  'growth.lv.8.name': 'Paragon',
  'growth.lv.8.reward': 'Unlock all coach styles',
  'growth.lv.9.name': 'Pathfinder',
  'growth.lv.9.reward': 'Earn a limited avatar frame',
  'growth.lv.10.name': 'XingYuan Master',
  'growth.lv.10.reward': 'Unlock all perks and become a XingYuan Master',
  ...
  'detail.grid.summary': 'Last {total} cells: {checked} checked, {missed} missed, {future} pending',
  'detail.legend.checked': 'Checked in',
  'detail.legend.missed': 'Missed',
  'detail.legend.future': 'Pending today',
  ...
  'err.no_opportunity_left': 'No check-in day left to tick — all opportunity days are done or past the deadline',
