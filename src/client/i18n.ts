...
const ZH_DICT = {
  ...
  'settings.pref.readOnly': '当前设置文档为只读，无法保存修改。',
  ...
  'settings.tabs.unavailable': '当前连接不支持持久化设置，标签页显示选项不可用。',
  ...
  'err.not_opportunity_day': '该日期不是机会日；可在日历页选择最近的机会日',
...
const EN_DICT: Record<XyKey, string> = {
  ...
  'action.checkinFuture': 'Commit {date}',
  ...
  'today.notCheckinDay': 'Not a check-in day today',
  ...
  'settings.pref.readOnly': 'The settings document is read-only; changes cannot be saved.',
  ...
  'settings.tabs.unavailable': 'This connection cannot persist settings; tab visibility options are unavailable.',
  ...
  'err.not_opportunity_day': 'Not an opportunity day — pick the nearest one in the Calendar tab',
