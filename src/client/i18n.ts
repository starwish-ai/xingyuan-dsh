...
export const ZH_DICT = {
  ...
  'settings.coach.hint': '决定对话语气与人设，也可在对话中说「对我严格一点」。',
  ...
  'settings.profile.nicknamePlaceholder': '希望被怎么称呼',
  'settings.profile.occupationPlaceholder': '如：教师、产品经理',
  'settings.profile.interestsPlaceholder': '如：阅读、跑步',
  'settings.profile.save': '保存画像',
  'settings.profile.saving': '保存中…',
  'settings.profile.saved': '画像已保存',
  'settings.profile.sharedHint': '留空的字段会被清除；画像与对话侧共享，对话里说「叫我小星」也会更新。',
  ...
  'settings.confirm.title': '写操作确认',
  'settings.confirm.master': '总开关',
  'settings.pref.confirmWritesHint': '开启后按下方类目决定是否弹确认卡；关闭后除删除（始终确认）外一律直接执行。',
  'settings.pref.confirmOps.group': '确认类目',
  'settings.pref.confirmOps.create': '创建愿望/任务（含微行动拆解）',
  'settings.pref.confirmOps.checkin': '打卡',
  'settings.pref.confirmOps.cancelCheckin': '取消打卡',
  'settings.pref.confirmOps.claim': '领取任务',
  'settings.pref.confirmOps.update': '修改愿望/任务/分类',
  'settings.pref.confirmOps.memorySave': '保存记忆',
  'settings.pref.confirmOps.delete': '删除（含批量、微行动重开）',
  'settings.pref.confirmOps.locked': '始终开启',
  'settings.pref.confirmOps.deleteHint': '始终确认，不可关闭：删除不可恢复。',
  'settings.pref.confirmOps.hint': '类目明细在总开关开启时生效；默认与之前版本一致。',
  ...
  'settings.pref.limitClamped': '超出 5-200 范围，已按最近的边界值保存',
  ...
  'chart.subtitle.claimedPercent': '%（已领取任务完成率）',
  'chart.subtitle.lastDays': '近 {n} 天',
  'chart.subtitle.daysClaimed': '{done}/{due} 天（已领取任务）',
...
const EN_DICT: Record<XyKey, string> = {
  ...
  'wish.planning': 'Planning',
  'wish.achieved': 'Achieved 🎉',
  'wish.pendingCount': '{n} to claim',
  'wish.settled': 'Wrapping up',
  ...
  'wish.settledSuffix': ' · {n} wrapping up',
  ...
  'settings.coach.hint': 'Shapes the coaching tone; you can also say “be tougher on me” in chat.',
  ...
  'settings.profile.nicknamePlaceholder': 'How should I call you?',
  'settings.profile.occupationPlaceholder': 'e.g. teacher, product manager',
  'settings.profile.interestsPlaceholder': 'e.g. reading, running',
  'settings.profile.save': 'Save profile',
  'settings.profile.saving': 'Saving…',
  'settings.profile.saved': 'Profile saved',
  'settings.profile.sharedHint': 'Empty fields are cleared. The profile is shared with chat; saying “call me Star” updates it too.',
  ...
  'settings.confirm.title': 'Confirmation before writes',
  'settings.confirm.master': 'Master switch',
  'settings.pref.confirmWritesHint': 'When on, confirmations follow the categories below; when off, everything except deletes (always confirmed) runs directly.',
  'settings.pref.confirmOps.group': 'Confirmation categories',
  'settings.pref.confirmOps.create': 'Create wishes/tasks (incl. micro-action plans)',
  'settings.pref.confirmOps.checkin': 'Check-ins',
  'settings.pref.confirmOps.cancelCheckin': 'Cancel check-ins',
  'settings.pref.confirmOps.claim': 'Claiming tasks',
  'settings.pref.confirmOps.update': 'Editing wishes/tasks/categories',
  'settings.pref.confirmOps.memorySave': 'Saving memories',
  'settings.pref.confirmOps.delete': 'Deletes (incl. batch & restarts)',
  'settings.pref.confirmOps.locked': 'Always on',
  'settings.pref.confirmOps.deleteHint': 'Always confirms and cannot be turned off; deletes are irreversible.',
  'settings.pref.confirmOps.hint': 'Category switches apply while the master switch is on; defaults match previous versions.',
  ...
  'settings.pref.limitClamped': 'Out of the 5-200 range; saved as the nearest allowed value.',
  ...
  'chart.subtitle.claimedPercent': '% of committed-task completion',
  'chart.subtitle.lastDays': 'Last {n} days',
  'chart.subtitle.daysClaimed': '{done}/{due} days (claimed tasks)',
